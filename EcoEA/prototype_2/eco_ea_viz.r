...
#Resources
resourceData = read.csv(paste(path, "/Resources.csv", sep=""))
plot = ggplot(resourceData, aes(x=generation, y=resources, color=target)) + labs(title = "Resource Available") + geom_line()
ggsave(paste(path, "/Resources.png", sep=""), height=6, width=10, units="in")
